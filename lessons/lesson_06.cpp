...
// ─────────────────────────────────────────────────────────────────────────────
// ТЕМА: Прототипы функций (Forward Declarations)
// ─────────────────────────────────────────────────────────────────────────────
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "   Урок 6: Функции" << std::endl;
    std::cout << "========================================\n" << std::endl;

    // =====================================================================
    // 1. ПРОСТЫЕ ФУНКЦИИ С ВОЗВРАЩАЕМЫМ ЗНАЧЕНИЕМ
    // =====================================================================
    ...
    // =====================================================================
    // 3. ПЕРЕДАЧА ПО ЗНАЧЕНИЮ vs ПО ССЫЛКЕ
    // =====================================================================
    ...
    //
    // Передача по константной ссылке (by const reference):
    ...
    //
    // C++: ВЫ ЯВНО ВЫБИРАЕТЕ способ передачи!
    //
    // ПРАВИЛО (learncpp.com):
    ...
    swap_values(x, y);  // Передача по ссылке — изменяет оригинал!
    ...
    // ВАЖНО: Параметры со значениями по умолчанию должны идти ПОСЛЕДНИМИ!
    //
    // Python: def greet(name="Мир"):
    // C++:    void greet(const std::string& name = "Мир")
    //
    // ВАЖНО: значения по умолчанию указываются в ОБЪЯВЛЕНИИ (прототипе),
    //         а НЕ в определении (если они разделены).
    ...
    //
    // ВАЖНО: В C++ нет ограничения глубины рекурсии (как в Python,
    ...
    // =====================================================================
    // 7. ФУНКЦИИ СО СТРОКАМИ И ВЕКТОРОМ
    // =====================================================================
