// =============================================================================
// Урок 3: Строки в C++ (std::string и std::string_view)
// =============================================================================
// Темы:
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "   Урок 3: Строки в C++" << std::endl;
    std::cout << "========================================\n" << std::endl;

    // =====================================================================
    // 1. C-СТРОКИ vs std::string
    // =====================================================================
    ...
    // =====================================================================
    // 3. ДЛИНА СТРОКИ И ДОСТУП К СИМВОЛАМ
    // =====================================================================
    ...
    // ВАЖНО: В C++ НЕТ отрицательных индексов! name[-1] — это UB!
    ...
    //
    // ВАЖНО: Нельзя конкатенировать ДВА литерала!
    //   "Hello" + " World"  — ОШИБКА! (это C-строки, а не std::string)
    //   std::string("Hello") + " World"  — ОК!
    //   "Hello"s + " World"  — ОК! (с литералом s, C++14)
    ...
    // ВАЖНО: В Python replace заменяет все вхождения!
    //        В C++ replace работает по позиции!
    ...
    // =====================================================================
    // 8. ПЕРЕБОР СИМВОЛОВ СТРОКИ
    // =====================================================================
    // 1. По индексу: for (std::size_t i = 0; i < str.size(); ++i)
    // 2. Range-based for: for (char c : str)  — РЕКОМЕНДУЕТСЯ
    ...
    // =====================================================================
    // 10. std::string_view (C++17) — «ЛЁГКИЙ ВЗГЛЯД»
    // =====================================================================
    // std::string_view — это НЕ копия строки, а только «взгляд» на неё.
    // Не выделяет память, не копирует данные.
    // Идеально для функций, которым нужно только прочитать строку.
    //
    // ВАЖНО: string_view НЕ владеет данными! Если оригинальная
