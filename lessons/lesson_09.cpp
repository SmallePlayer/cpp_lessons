// =============================================================================
// Урок 9: Структуры и Классы (ООП — Часть 1)
// =============================================================================
// Темы:
...
// =====================================================================
// 1. struct — ПРОСТЕЙШАЯ СТРУКТУРА ДАННЫХ
// =====================================================================
...
// =====================================================================
// 2. class — ПОЛНЫЙ КЛАСС С ИНКАПСУЛЯЦИЕЙ
// =====================================================================
...
public:
    ...
    // ─── МЕТОДЫ ───
    // const после метода = метод НЕ изменяет объект
    //
...
// Инициализация статического члена (ОБЯЗАТЕЛЬНО вне класса!):
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "   Урок 9: Структуры и Классы" << std::endl;
    std::cout << "========================================\n" << std::endl;
