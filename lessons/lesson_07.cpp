// =============================================================================
// Урок 7: Массивы, Векторы и Контейнеры STL
// =============================================================================
// Темы:
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "   Урок 7: Контейнеры STL" << std::endl;
    std::cout << "========================================\n" << std::endl;

    // =====================================================================
    // 1. C-МАССИВЫ (СТАТИЧЕСКИЕ)
    // =====================================================================
    // int arr[5] = {1, 2, 3, 4, 5};
    //
    // Проблемы C-массивов:
    ...
    //
    // СОВЕТ: НЕ используйте C-массивы! Используйте std::array или std::vector!
    ...
    // =====================================================================
    // 2. std::array (C++11) — БЕЗОПАСНЫЙ МАССИВ С ФИКСИРОВАННЫМ РАЗМЕРОМ
    // =====================================================================
    ...
    // =====================================================================
    // 3. std::vector — ГЛАВНЫЙ КОНТЕЙНЕР
    // =====================================================================
    // std::vector — ГЛАВНЫЙ контейнер в C++!
    // Это аналог Python list, но типизированный.
    //
    ...
    // =====================================================================
    // 5. std::map — АССОЦИАТИВНЫЙ МАССИВ (СЛОВАРЬ)
    // =====================================================================
    ...
    // =====================================================================
    // 6. std::unordered_map — БЫСТРЫЙ СЛОВАРЬ
    // =====================================================================
