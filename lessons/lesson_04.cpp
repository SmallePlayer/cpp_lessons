// =============================================================================
// Урок 4: Условия и логические операторы
// =============================================================================
// Темы:
//   - if, else if, else
//   - Операторы сравнения (==, !=, <, >, <=, >=)
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "   Урок 4: Условия и логика" << std::endl;
    std::cout << "========================================\n" << std::endl;
    ...
    //   }
    //
    // ВАЖНО: Условие ДОЛЖНО быть в скобках ()!
    // СОВЕТ: Тело — в фигурных скобках {}! (можно без, если одна строка,
    ...
    //
    // ЛОВУШКА: == (сравнение) vs = (присваивание)!
    ...
    //
    // ВАЖНО: Не забывайте break! Без него выполнение «провалится»
    ...
    // =====================================================================
    // Краткая форма if/else для ВЫБОРА значения.
    //
    ...
    //
    // Используйте для ПРОСТЫХ условий. Для сложных — обычный if.
    ...
    // Вложенный тернарный (НЕ рекомендуется — плохо читается!):
    int val{75};
    ...
    // =====================================================================
    // 7. ОБЛАСТЬ ВИДИМОСТИ ПЕРЕМЕННЫХ В БЛОКАХ
    // =====================================================================
    ...
    //       int x = 10;
    //   }
    //   std::cout << x;  // ОШИБКА! x не существует здесь!
    ...
    // std::cout << inner;  // ОШИБКА! inner не существует здесь!
    std::cout << "outer (после if) = " << outer << " (доступна)" << std::endl;
    std::cout << std::endl;

    // =====================================================================
    // 8. ОБЪЯВЛЕНИЕ ПЕРЕМЕННОЙ В if (C++17)
    // =====================================================================
